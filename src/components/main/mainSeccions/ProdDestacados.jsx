    ...
    return (
        <div className="p-6" >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-6">
                <div className="row-start-1 col-start-1 row-span-2 col-span-2">
                    <div className="bg-black text-white w-full h-full rounded-b-lg flex flex-col justify-end">
                        ...
                        <div className="absolute w-fit p-4  rounded-b-lg ">
                            ...
                            <a href="" className="text-green-500 font-bold mt-2 inline-block">Shop Now</a>
                        </div>
                    </div>
                </div>

                <div className="h-full row-start-1 col-start-3 col-span-2">
                    <div className="bg-black text-white w-full h-full rounded-b-lg flex flex-col justify-end">
                ...
                <div className="h-full row-start-2 col-start-3 col-span-1">
                ...
                <div className="h-full row-start-2 col-start-4 col-span-1">
                    <div className="bg-black p-4 text-white w-full h-full rounded-b-lg flex flex-col justify-end">
