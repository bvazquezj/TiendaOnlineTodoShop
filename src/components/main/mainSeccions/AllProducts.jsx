    ...
    return(
        ...
        <div className="text-center mb-8 flex flex-col">
            <div className="flex items-center">
                ...
                <p className="inline-block text-xs text-red-600 font-bold">Productos</p>
            </div>
            <div className="w-full mb-8 flex items-center justify-between">
                <h2 className="inline-block text-2xl font-bold mr-20">Todos los productos</h2>
                <div>
        ...
        <div className="text-center my-8 ">
            <button className="bg-red-500 text-xl text-white px-6 py-2 rounded-lg">Ver mas</button>
        </div>
    </div>
    );
}